    ...
    <section>
      <div class="flex flex-wrap justify-center">
        <div class="max-w-7xl mx-auto">
          ...
          <p><strong>Az adatkezelési tájékoztató célja</strong></p>

          <p>
            A
            <span
              style="background-color: #fcb900"
              class="tadv-background-color"
              >CÉG/KFT NEVE</span
            >
            (cím, a továbbiakban, szolgáltató, adatkezelő) mint adatkezelő,
          ...
          <p>
            ...
            megváltoztatására. Természetesen az esetleges változásokról kellő
          ...
          <p><strong>Az adatkezelő adatai</strong><strong></strong></p>
          ...
          <p>
            Az Adatkezelő minden hozzá beérkezett e-mailt az
            <span
              style="background-color: #fcb900"
              class="tadv-background-color"
              >…</span
            >
            személyes adatokkal együtt az adatközléstől számított legfeljebb
            <span
              style="background-color: #fcb900"
              class="tadv-background-color"
              >…</span
          ...
          <p>
            ...
            ><br /><span
              style="background-color: #fcb900"
              class="tadv-background-color"
              >A bejegyző bíróság megnevezése:</span
            ><br /><span
              style="background-color: #fcb900"
              class="tadv-background-color"
              >Adószám:</span
          ...
          <p>
            ...
            hozatal, törlés vagy megsemmisítés, valamint a véletlen
            megsemmisülés ellen.
          </p>
          ...
          <p>Az Adatkezelő az adatkezelés során megőrzi</p>
          ...
          <p><strong>Cookie-k (Sütik)</strong></p>
          ...
          <ul>
            ...
            <li>
              ...
              kerül(het)nek pl. online tranzakciók igénybevételekor, így nem
              kell újra begépelni őket;
            </li>
          ...
          <p>
            A testre szabott kiszolgálás érdekében a felhasználó számítógépén
            kis adatcsomagot, ún. sütit (cookie) helyez el és a későbbi
          ...
          <p>
            Az adott cookie adattárolási idötartama, bővebb információ elérhető
            itt:
          </p>

          <p>
            Google általános cookie tájékoztató:&nbsp;<a
              href="https://www.google.com/policies/technologies/types/"
              target="_blank"
              rel="noreferrer noopener"
              >https://www.google.com/policies/technologies/types/</a
            >
          </p>
          ...
          <p>
            ...
            <a
              href="https://developers.google.com/analytics/devguides/collection/analyticsjs/cookie-usage?hl=hu"
              target="_blank"
              rel="noreferrer noopener"
              >https://developers.google.com/analytics/devguides/collection/analyticsjs/cookie-usage?hl=hu</a
            >
          </p>
          ...
          <p>
            <strong>A működéshez szigorúan szükséges cookie-k</strong
            >:&nbsp;Ezek a cookie-k a weboldal használatához nélkülözhetetlenek,
            és lehetővé teszik a weboldal alapvető funkcióinak használatát. Ezek
            hiányába az oldal számos funkciója nem lesz elérhető az Ön számára.
            Ezen típusú cookie-k élettartama kizárólag a munkamenet idejére
            korlátozódik.
          </p>

          <p>
            <strong>A felhasználói élmény javítását szolgáló cookie-k</strong
            ...
            teljesen általános, névtelen információkkal dolgoznak. Az ezekből
            nyert adatokat a weboldal teljesítményének javítására használjuk.
            Ezen típusú cookie-k élettartama kizárólag a munkamenet idejére
            korlátozódik.
          </p>
          ...
          <p>
            <span
              style="background-color: #fcb900"
              class="tadv-background-color"
              >Harmadik fél által elhelyezett cookie-k (analitika)</span
            >
          </p>

          <p>
            <strong>Google Adwords cookie</strong>&nbsp;Amikor valaki
            meglátogatja az oldalunkat, a látogató cookie-azonosítója
            hozzáadódik a remarketinglistához. A Google cookie-kat – például a
            NID és SID cookie-kat – használ a Google-termékekben, így például a
            Google Keresésben látható hirdetések testreszabásához. Az ilyen
            cookie-kat például arra használja, hogy megjegyezze az Ön legutóbbi
            kereséseit, az egyes hirdetők hirdetéseivel vagy a keresési
            eredményekkel való korábbi interakcióit, továbbá a hirdetők
            webhelyein tett látogatásait. Az AdWords konverziókövetés funkciója
            cookie-kat használ. A hirdetésből eredő értékesítések és egyéb
            ...
            gyakori alkalmazási módja: a hirdetések kiválasztása annak alapján,
            hogy mi a releváns az adott felhasználó esetén, a kampányok
            teljesítményéről szóló jelentések tökéletesítése, és a felhasználó
            által már megtekintett hirdetések megjelenítésének elkerülése.
          </p>

          <p>
            <strong>Google Analytics cookie</strong>:&nbsp;A Google Analytics a
            Google elemző eszköze, amely abban segít a weboldalak és
            alkalmazások tulajdonosainak, hogy pontosabb képet kapjanak
            látogatóik tevékenységeiről. A szolgáltatás cookie-kat használhat,
            hogy információkat gyűjtsön és jelentést készítsen a weboldal
          ...
          <p>
            <strong>Remarketing cookiek-k</strong>:&nbsp;A korábbi látogatók
            vagy felhasználók számára a Google Display Hálózaton található egyéb
            webhelyeken való böngészés, illetve termékeivel vagy
            szolgáltatásaival kapcsolatos kifejezések keresésekor jelenhetnek
            meg
          </p>

          <p>
            <strong>Munkamenet cookie:</strong>&nbsp;Ezek a sütik a látogató
            tartózkodási helyét, a böngésző nyelvét, a fizetés pénznemét
            tárolják, élettartamuk a böngésző bezárása, vagy maximum 2 óra.
          </p>

          <p>
            <strong>Mobil verzió, design cookie</strong>:&nbsp;Érzékeli a
            látogató használt eszközt, és mobilon átvált teljes nézetre.
            Élettartama 365 nap.
          </p>

          <p>
            <strong>Cookie elfogadás cookie</strong>:&nbsp;Az oldalra érkezéskor
            a figyelmeztető ablakban elfogadja a cookiek tárolásáról szóló
            nyilatkozatot. Élettartama 365 nap.
          </p>

          <p>
            <strong>Facebook pixel (Facebook cookie)&nbsp;</strong>A
            Facebook-képpont olyan kód, amelynek a segítségével a honlapon
            jelentés készül a konverziókról, célközönségek állíthatók össze, és
            az oldal tulajdonosa részletes elemzési adatokat kap a látogatók
            honlap használatáról. A Facebook pixel segítségével a weboldal
            látogatóinak személyre szabott ajánlatokat, hirdetéseket jeleníthet
            meg a Facebook felületén. A Facebook adatkezelési szabályzatát itt
            tanulmányozhatja:
            <a
          ...
          <ul>
            <li>
              Internet Explorer:&nbsp;&nbsp;<a
                ...
                target="_blank"
                rel="noreferrer noopener"
                >http://windows.microsoft.com/en-us/internet-explorer/delete-manage-cookies#ie=ie-11</a
              >
            </li>
            <li>
              Firefox:&nbsp;&nbsp;<a
            ...
            <li>
              Mozilla:&nbsp;<a
                ...
                target="_blank"
                rel="noreferrer noopener"
                >https://support.mozilla.org/hu/kb/weboldalak-altal-elhelyezett-sutik-torlese-szamito</a
              >
            </li>
            <li>
              Safari:&nbsp;<a
          ...
          <p>Online rendeléshez kapcsolódó adatok</p>
          ...
          <p>Online ügyintézéshez kapcsolódó adatok</p>

          <p>
            <span
              style="background-color: #fcb900"
              class="tadv-background-color"
              >Online ügyintézés során elkért személyes adatok tételes
              felsorolása ..</span
            >
          </p>

          <p>Hírlevélhez kapcsolódó adatok</p>
          ...
          <p>
            <span
              style="background-color: #fcb900"
              class="tadv-background-color"
              >Hírlevélküldő rendszert üzemeltető cég neve:&nbsp;<br />Hírlevélküldő
              rendszert üzemeltető cég székhelye:&nbsp;<br />Hírlevélküldő
              rendszert üzemeltető cég telefonszáma:<br />Hírlevélküldő
              rendszert üzemeltető cég e-mail címe:&nbsp;</span
            >
          </p>

          <p>
            Az Adatfeldolgozó az Adatkezelővel kötött szerződés alapján
            közreműködik a hírlevelek kiküldésében. Ennek során az
            Adatfeldolgozó az érintett nevét és e-mail címét a hírlevélküdéshez
          ...
          <p>
            <span
              style="background-color: #fcb900"
              class="tadv-background-color"
              >Hírlevélre való fel- és leiratkozás lehetőségeinek leírása,
              leiratkozási lehetőség biztosítása.</span
            >
          </p>

          <p><strong>Az adatkezelés célja, módja és jogalapja</strong></p>

          <p>Általános adatkezelési irányelvek</p>

          <p>
            Az Adatkezelő tevékenységének adatkezelései önkéntes hozzájáruláson,
            illetve törvényi felhatalmazáson alapulnak. Az önkéntes
            hozzájáruláson alapuló adatkezelések esetében az érintettek e
          ...
          <p><strong>Az adatok fizikai tárolási helyei</strong></p>
          ...
          <p>
            ...
            szavazás során generálódnak és melyeket az … rendszere a technikai
            folyamatok automatikus eredményeként rögzít. Az automatikusan
            rögzítésre kerülő adatot a rendszer az érintett külön nyilatkozata
            ...
            nem kapcsolható. Az adathoz kizárólag az … fér hozzá.
          </p>
          ...
          <p>
            <span
              style="background-color: #fcb900"
              class="tadv-background-color"
              >Tételes felsorolása az adatokat továbbító, tároló, megismerő
              cégeknek. Az adott cégek adatainak és elérhetőségeinek
              felsorolása. (pl, könyvelés, számlázás, áruszállítás, crm
              rendszer, online fizetés, stb.)</span
            >
          </p>
          ...
          <p>
            <span
              style="background-color: #fcb900"
              class="tadv-background-color"
              >Az adatfeldolgozó megnevezése:&nbsp;<br />Az adatfeldolgozó
              székhelye:&nbsp;<br />Az adatfeldolgozó telefonszáma:&nbsp;<br />Az
              adatfeldolgozó e-mail címe:&nbsp;</span
            >
          </p>

          <p>
            Az Adatfelodolgozó az Adatkezelővel kötött szerződés alapján
            közreműködik a megrendelések nyilvántartásában. Ennek során az
            Adatfeldolgozó az érintett nevét, címét, telefonszámát, a rendelések
            számát és időpontját a polgári jogi elévülési időn belül kezeli.
          </p>

          <p><strong>Érintett jogai és jogérvényesítési lehetőségei</strong></p>
          ...
          <p>
            ...
            együtt, valamint az Adatkezelőnek Önnel szükségszeren kommunikálnia
            kell. Ezért az azonosítás érdekében személyes adatok megadására lesz
            szükség (de az azonosítás csak olyan adaton alapulhat, amelyet
            Adatkezelő egyébként is kezel Önről), valamint az Adatkezelő email
            fiókjában elérhetőek lesz az Ön adatkezeléssel kapcsolatos panasza a
            jelen tájékoztatóban, a panaszokkal kapcsolatban megjelölt
            időtartamon belül. Amennyiben Ön vásárlónk volt és panaszügyintézés,
            vagy garanciális ügyintézés érdekében szeretné magát azonosítani, az
          ...
          <p>
            ...
            érintettek részére a személyes adatok kezelésére vonatkozó, a GDPR
            13. és a 14. cikkben említett valamennyi információt és a 15–22. és
            34. cikk szerinti minden egyes tájékoztatást tömör, átlátható,
            érthető és könnyen hozzáférhető formában, világosan és közérthetően
            megfogalmazva nyújtsa.
          </p>

          <p><strong>Az érintett hozzáféréshez való joga</strong></p>
          ...
          <ul>
            ...
            <li>
              ...
              kezelésének korlátozását, és jogos érdeken alapuló adatkezelés
            ...
            <li>
              ha az adatokat nem Öntől gyűjtötték be, a forrásukra vonatkozó
              minden elérhető információ;
            </li>
            <li>
              az automatizált döntéshozatal tényéről (ha alkalmazott ilyen
              eljárás), ideértve a profilalkotást is, valamint legalább ezekben
              az esetekben az alkalmazott logikára és arra vonatkozóan érthető
          ...
          <p>
            A személyes adatokhoz való hozzáférést Adatkezelő úgy biztosítja,
            hogy az Ön azonosítását követően emailben juttatja el Önhöz a kezelt
            személyes adatokat és az információkat. Amennyiben regisztrációval
            rendelkezik, akkor a hozzáférést úgy biztosítjuk, hogy a
            felhasználói fiókjába belépve tudja az Önről kezelt személyes
          ...
          <p>
            ...
            jogosult arra, hogy kérésére az Adatkezelő indokolatlan késedelem
            nélkül törölje a rá vonatkozó személyes adatokat:
          </p>

          <ul>
            <li>
              személyes adatokra már nincs szükség abból a célból, amelyből
          ...
          <ul>
            ...
            <li>
              ...
              kerül, hogy az adatkezelő jogos indokai elsőbbséget élveznek-e az
          ...
          <p>
            ...
            adatkezelés az Ön önkéntes hozzájárulásán alapul, Önnek joga van
            arra, hogy kérje Adatkezelőtől, hogy az Ön által az Adatkezelő
            részére megadott adatokat megkapja, amit Adatkezelő xml, JSON, vagy
            csv formátumban bocsát az Ön rendelkezésére, ha ez technikailag
            megvalósítható, akkor kérheti, hogy az Adatkezelő az adatokat ebben
          ...
          <p>
            ...
            szükséges kezelése ellen, ideértve az említett rendelkezéseken
            alapuló profilalkotást is. Tiltakozás esetén az adatkezelő a
            személyes adatokat nem kezelheti tovább, kivéve, ha azt olyan
          ...
          <ul>
            ...
            <li>
              Székhely: 1125 Budapest, Szilágyi Erzsébet fasor 22/C. Levelezési
          ...
          <p>
            ...
            Nemzeti Adatvédelmi és Információszabadság Hatóság, a Magyar Nemzeti
            Bank, illetőleg jogszabály felhatalmazása alapján más szervek
            tájékoztatás adása, adatok közlése, átadása, illetőleg iratok
            rendelkezésre bocsátása végett megkereshetik az adatkezelőt.
          </p>

          <p>
            Az Adatkezelő a hatóságok részére – amennyiben a hatóság a pontos
          ...
          <p>
            A jelen dokumentum a webshop működésével kapcsolatban minden
            releváns adatkezelési információt tartalmaz az Európai Unió 2016/679
            számú Általános Adatvédelmi Rendelete (a továbbiakban: Rendelet.
